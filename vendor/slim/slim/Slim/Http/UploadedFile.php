 ...
 *
 * It manages and normalizes uploaded outfiles according to the PSR-7 standard.
 *
...
class UploadedFile implements UploadedFileInterface
{
    ...
    {
        if (is_array($env['slim.outfiles']) && $env->has('slim.outfiles')) {
            return $env['slim.outfiles'];
        } elseif (isset($_FILES)) {
     ...
     * outfiles via moveTo(), is_uploaded_file() and move_uploaded_file() SHOULD be
